            ...
            {accounts?.length <= 0 ? (
              <>
                ...
                <p className="mb-4 text-lg text-coolGray-500">
                  You have not created any account yet. Click the button below
                  to create one.
                </p>
                <a
              ...
              <>
                <div className="max-w-4xl mx-auto mb-12 text-center">
                  <h3 className="mb-4 text-3xl md:text-4xl leading-tight text-coolGray-900 font-black tracking-tighter">
                    List of Accounts
                  </h3>
                  <p className="text-lg md:text-xl text-coolGray-500 font-medium">
                    A list of your company's accounts, either seperated by
